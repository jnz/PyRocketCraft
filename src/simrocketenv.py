...
class SimRocketEnv(gym.Env):
    ...
    def _set_camera_follow_object(self, object_id, distance=4.5, pitch=-55, yaw=50):
        """
        Helper function to set camera to object.
        """
        pos, orn = p.getBasePositionAndOrientation(object_id, physicsClientId=self.CLIENT)
